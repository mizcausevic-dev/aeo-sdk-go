...
### Released
- Published **aeo-sdk-go** as a public, portfolio-grade answer-engine visibility system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **aeo-sdk-go**.
- Standardized the core objects, decision surfaces, and operator outputs around the repo's main working problem.
- Established the first reviewable version of the architecture described as: Go SDK for the AEO Protocol v0.1. Parse, build, validate, and fetch AEO declaration documents. Zero non-stdlib dependencies. Strict json.DisallowUnknownFields parsing. Context-aware HTTP client.
...
- That insight became the basis for **aeo-sdk-go**.
