...
### Released
- Shipped **aeo-sdk-go** as a public artifact for teams dealing with answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **aeo-sdk-go** with stable domain objects, review surfaces, and decision outputs.
